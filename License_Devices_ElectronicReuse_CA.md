...
2. Ets lliure de saber com és, els seus recursos, com funciona, replicar-lo i difondre'n el seu esperit i funcionament.
...
1. Un Circuit Comú de Dispositius Digitals o un Circuit és una expressió de valors fonamentals com la llibertat, la sostenibilitat, la circularitat, la igualtat d'oportunitats, la solidaritat i la fraternitat, que promou el dret de tota persona a la seva alfabetització digital, i el dret ambiental i laboral d'explotar un recurs per evitar-ne el seu reciclatge prematur, en favor d'un ús responsable dels recursos, i d'acord amb els principis generals, que es faran servir d'inspiració en cas d'haver de resoldre qualsevol dubte sobre la seva interpretació.

2. Un Circuit és circular quan els usuaris que l'implementen tenen com a propòsit produir, traçar i mantenir els dispositius que hi circulen el màxim de temps en ús i en volen garantir el seu reciclatge final. Per fer-ho possible un Circuit necessita d'un sistema de recursos (**dispositius, coneixement, dades, eines, procediments, serveis, llicències, mètodes i models de negoci**), que cal preservar, sostenir i millorar. 

3. Un Circuit és d'accés i de participació oberta en quan els usuaris el poden usar, contribuir al sistema de recursos i participen del seu desenvolupament, operacions i governança.

4. Un Circuit ha de promoure el consum i producció de dispositius circulars. Un dispositiu digital és circular si és durable, és viable la seva **reparació** i existeixen **recanvis**, és pot millorar/actualitzar amb **mòduls**, permet un **diagnòstic** desatès, es poden **identificar** de manera única la majoria dels seus components per a possibilitar-ne la **traçabilitat**, i és fàcil de desmantellar i se'n poden recuperar (**reciclar**) de manera eficient les matèries primeres empleades en la fabricació.  

5. Un Circuit és un acord d'adhesió i explotació que fa entre iguals, de cada participant amb el conjunt, i que és comú per a tothom que en forma part. El Circuit va lligat a una llicència, i aquesta fa alhora les funcions de contracte d'adhesió i de llicència d'ús del sistema de recursos, esdevenint així una garantia per qui el subscriuen sobre quins son els termes i condicions aplicables i que son iguals per tothom. La creació de Circuits no es exclusiu i se'n poden crear llicències derivades.
...
Als cedents se’ls hi ha de garantir la reutilització, la traçabilitat i el reciclatge, respectar les seves polítiques com per exemple la selecció de proveïdors i receptors, i volen conèixer l'estat dels dispositius que donen i saber si són tractats legalment.
...
a) El sistema de recursos s’ha de preservar, sostenir i millorar:
...
b) El posseïdor actual d'un dispositiu del circuit ha de tractar de mantenir-los en circulació i evitar-ne el reciclatge prematur, via la reducció, reparació i actualització de components. Un cop el posseïdor se'n vol despendre, ha de facilitar que torni al circuit esdevenint un donant, i adreçant-se al circuit (o d'altres circuits si es permet en la llicència, i en cas que no hi hagi demanda, ha de portar-lo preferiblement a un punt verd del circuit, i en cas de no ternir-ne un de proximitat, s'ha de portar a un punt verd de les autoritats competents.

c. Els posseïdors dels dispositius han de traçar els dispositius i components fent ús de les eines del circuit amb l’objectiu de reduir la seva pèrdua i facilitar-ne el seu reús.

## VI. Acords específics dels grups d'interès

Aquesta és una proposta de mínims que permet preservar, sostenir i millorar el sistema de recursos del comú i si es vol nous acords poden definir-se en llicències derivades.

#### Cedents
1. Oferir al gestor i als seus proveïdors un espai adequat on fer el diagnòstic, preparació i inventariat dels dispositius doncs permet als proveïdors optimitzar el procés i als cedents donar directament els dispositius directament reutilitzables.
2. Notificar al gestor amb suficient antelació d'una cessió de béns doncs permet planificar i identificar la demanda reduïnt els temps de estock.  
3. Permetre als proveïdors tenir emmagatzemats els dispositius preparats per a la reutilització als seus magatzems doncs evita un transport inecessari dels dispositius fins a les instal·lacions del proveïdor i dóna garanties al cedent de la seva reutilització. 

#### Receptors
1. Notificar al gestor de la ubicació geogràfica dels dispositius (nomes a nivell de ciutat).
2. Notificar al gestor amb un més d'antelació abans de despendres dels dispositius (i components), notificar les causes i en cas que el gestor ho consideri fer novament la seva cessió als proveïdors o receptors que proposi el gestor, sempre que sigui reaonablement possible. 
3. Contractar els serveis dels proveïdors del circuit o en cas d'impossibilitat (també per preu), promouran la incorporació de nous proveïdors sota les condicions de llicència del circuit.

#### Gestors.
1. Notificar els dispositius que gestionen i la ubicació geogràfica a nivell de ciutat.

#### Proveïdors
1. Els proveïdors de preparació per a la reutilització i de reciclatge han de donar-se d'alta al sistema DCP.
2. Els proveïdors de reciclatge han de notificar l'ubicació geogràfica dels dispositius que reben.
3. Els proveïdors de preparació per a la reutilització han de prioritzar la preparació al reciclatge, i intentar donar-ne sortida de reus. 

#### Administració pública

## VIII. Sobre la gestió del circuit, quotes, serveis, reputació i rendiment.
#### Quota dispositius.
Els dispositius s’assignen als proveïdors i receptors en base a la voluntat del cedent, el volum tractable, els rendiments de circularitat i la reputació otorgada pels altres usuaris. La quota es revisable de manera transparent pels gestors i es poden incorporar altres criteris i mecanismes.
...
El indicador de traçabilitat. components traçats / components rebuts.
...
### X. Sobre la Llicència General d'un Comú Circular de Dispositius
