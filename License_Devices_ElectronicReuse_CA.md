...
2. Un circuit és circular quan els usuaris que l'implementen tenen com a propòsit traçar i mantenir els dispositius que hi circulen el màxim de temps en ús i en garanteixen el seu reciclatge final, per això, el circuit necessita d'un sistema de recursos (**donants, dispositius, coneixement, dades, eines, procediments, serveis, llicències, mètodes i models de negoci**), que cal conceptualitzar, preservar, sostenir i millorar. 

3. Un circuit és d'accés i de participació oberta quan els usuaris poden usar i contribuir al sistema de recursos i participen del desenvolupament, operacions i governança.

4. Un circuit ha de promoure el consum i producció de dispositius circulars. Un dispositiu digital és circular si és durable, és viable la seva **reparació** i existeixen **recanvis**, és pot millorar/actualitzar amb **mòduls**, permet un **diagnostic** desatès, es poden **identificar** de manera única la majoria dels seus components per a possibilitar-ne la **traçabilitat**, i és fàcil de desmantellar i se'n poden recuperar (**reciclar**) de manera eficient les matèries primeres empleades en la fabricació.  
...
#### Cedents
Individus o organitzacions disposats a transferir dispositius sota certes condicions (donació, venta, ...) determinats en una llicència llicència derivada, i que estan interessats a conèixer l'estat dels dispositius que donen; si són tractats legalment, traçats, seguint les seves polítiques i finalment es reciclen.

#### Receptors
Individus o entitats que fan reús dels dispositius digitals.

#### Gestors i voluntaris
Entitats que gestionen el comú seguint els principis fonamentals i les consideracions anteriorment presentades. Els seus individus normalment són investigadors, professorat, advocats, analistes, auditors i col·laboradors voluntaris, preocupats per la sostenibilitat del medi ambient, la gestió del sistema de recursos, la reducció de la fractura digital, el desenvolupament de programari, l'economia circular, el reciclatge, la protecció dels drets dels consumidors, la protecció dels drets del ciutadà, o la protecció del medi ambient. Participen en la gestió transparent per a l’assignació dels dispositius i serveis als usuaris, el monitoratge dels circuits, la promoció de nous circuits, la creació i revisió de llicències.

#### Proveïdors
Professionals o voluntaris que presten serveis per estendre el temps de vida dels dispositius i garantir-ne el seu reciclatge final. Els formen els reparadors, preparadors per a la reutilització, re-fabricants, distribuïdors com plataformes socials o comerços, transportistes, tallers de reparació, de manteniment, entitats de garantia i gestors de residus i reciclatge.
...
1. Assegurar la reutilització i el reciclatge
2. Maximització de la utilitat
...
a) El sistema de recursos s’ha de conceptualitzar, preservar, sostenir i millorar:

1. Els cedents se’ls hi ha de garantir la reutilització, la traçabilitat, el reús en el propòsit per al que van fer la cessió i el reciclatge final.
2. Els dispositius han de ser el màxim de circulars per a reduir els costos i riscos de manteniment.
3. Les dades han de permetre la millora continuada dels processos i han d’oferir als consumidors informació fiable i de suport a la selecció de dispositius circulars
4. Les eines han de ser en programari lliure per a facilitar-ne la seva millora, aprenentatge i millora.
5. Els procediments han de ser oberts i han de permetre la seva optimització continuada.
6. Els serveis de gestió i dispositius han d’integrar-se amb les eines del circuit.
7. Les llicències han de ser respectades i millorades.

b) Els posseïdors dels dispositius han de tractar de mantenir-los en circulació i evitar-ne el reciclatge prematur, via la reparació, actualització i substitució de components, i un cop el posseïdor se'n vol despendre, facilitar que torni al circuit, i en cas que no tingui demanda, ha de portar-lo a un punt verd del circuit (proveïdor de reciclatge) o en el seu defecte un punt verd autoritzat per les autoritats competents.
...
#### Cedents
1. Oferir al gestor i als seus proveïdors d’un espai adequat on fer el diagnòstic i inventariat dels dispositius.
2. Avisar amb antelació de cessió de béns.
3. Permetre durant un període de temps tenir els dispositius reutilitzables directament a les seves instal·lacions.

#### Receptors
1. Notificar al gestor de la ubicació geogràfica del maquinari (a nivell de ciutat).
2. Notificar al gestor de quin(s) dispositiu (i components) es volen desprendre i esperaran fins a 1 mes per a que el gestor en pugui cercar el proveïdor o un nou receptor.
...
#### Proveïdors
1. Els proveïdors de reciclatge han de donar-se d'alta al sistema DCP
2. Els proveïdors han de notificar l'ubicació geogràfica dels dispositius a nivell de lloc (**place**)
3. Els proveïdors han de prioritzar la preparació per a la reutilització al reciclatge i cal que cerquin 4. acords de cooperació amb d'altres proveïdors per a tractar de donar sortida al maquinari preparat al que ells no poden donar sortida de reus, o el maquinari per preparar, evitant així el seu reciclatge per falta de demanda.
